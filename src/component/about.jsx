...
const About = () => {
    return (
<MotionDiv className="border-b border-purple-500/10 pb-24">            <motion.h1 whileInView={{opacity:1 , y:0}} initial={{opacity:0 , y:-100}}  transition={{duration:0.8, delay:0.5}} className="my-20 text-center text-4xl">About <span className="text-netural-500">Me</span></motion.h1>
